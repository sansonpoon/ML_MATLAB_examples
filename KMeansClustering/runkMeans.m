...
%     also plot its progress as the learning happens. This is set to false by default. 
%   - runkMeans returns centroids, a K x n matrix of the computed centroids and idx, a m x 1 
